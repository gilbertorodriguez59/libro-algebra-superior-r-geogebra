...
[Abrir en Google Colab](https://colab.research.google.com/github/gilbertorodriguez59/libro-algebra-superior-r-geogebra/blob/main/notebooks/capitulo-02-enteros-reales-R.ipynb){.btn .btn-primary target="_blank"} [Descargar el cuaderno](https://gilbertorodriguez59.github.io/libro-algebra-superior-r-geogebra/notebooks/capitulo-02-enteros-reales-R.ipynb){.btn target="_blank"}
:::
...
| Cuaderno de Google Colab | Cuaderno completo del capítulo con código y ejercicios en R. | [Abrir en Google Colab](https://colab.research.google.com/github/gilbertorodriguez59/libro-algebra-superior-r-geogebra/blob/main/notebooks/capitulo-02-enteros-reales-R.ipynb){target="_blank"} |
...
![La suma acumulada de impares coincide con los cuadrados perfectos.](figures/induccion-impares.png){#fig-induccion-impares width=88% fig-alt="Arreglos de puntos muestran que la suma de números impares consecutivos forma cuadrados perfectos."}
...
[Abrir el laboratorio de inducción](https://gilbertorodriguez59.github.io/libro-algebra-superior-r-geogebra/interactivos/induccion-impares.html){.btn .btn-primary target="_blank"}
...
![Los pares sucesivos del algoritmo de Euclides terminan en el máximo común divisor.](figures/algoritmo-euclides.png){#fig-algoritmo-euclides width=88% fig-alt="Esquema de las divisiones sucesivas del algoritmo de Euclides hasta obtener el máximo común divisor."}
...
[Abrir el algoritmo de Euclides](https://gilbertorodriguez59.github.io/libro-algebra-superior-r-geogebra/interactivos/algoritmo-euclides.html){.btn .btn-primary target="_blank"}
...
![Cadena de factorización y descomposición prima de $756$.](figures/arbol-factorizacion.png){#fig-arbol-factorizacion width=82% fig-alt="Árbol que descompone 756 paso a paso hasta obtener únicamente factores primos."}
...
![Los naturales, enteros, racionales e irracionales se sitúan dentro de los reales.](figures/jerarquia-numeros.png){#fig-jerarquia-numeros width=92% fig-alt="Diagrama de inclusión de los números naturales, enteros, racionales y reales."}
...
![La desigualdad $|x-a|\le r$ selecciona un intervalo centrado en $a$.](figures/valor-absoluto.png){#fig-valor-absoluto width=90% fig-alt="Recta numérica que interpreta el valor absoluto como distancia a un punto central."}
...
[Abrir el laboratorio de valor absoluto](https://gilbertorodriguez59.github.io/libro-algebra-superior-r-geogebra/interactivos/valor-absoluto.html){.btn .btn-primary target="_blank"}
