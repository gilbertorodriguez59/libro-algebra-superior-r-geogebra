...
[Abrir en Google Colab](https://colab.research.google.com/github/gilbertorodriguez59/libro-algebra-superior-r-geogebra/blob/main/notebooks/capitulo-01-logica-conjuntos-R.ipynb){.btn .btn-primary target="_blank"} [Descargar el cuaderno](https://gilbertorodriguez59.github.io/libro-algebra-superior-r-geogebra/notebooks/capitulo-01-logica-conjuntos-R.ipynb){.btn target="_blank"}
:::
...
| Cuaderno de Google Colab | Cuaderno completo del capítulo con código y ejercicios en R. | [Abrir en Google Colab](https://colab.research.google.com/github/gilbertorodriguez59/libro-algebra-superior-r-geogebra/blob/main/notebooks/capitulo-01-logica-conjuntos-R.ipynb){target="_blank"} |
...
::: {.callout-tip title="Actividad con el laboratorio publicado"}
Use la salida de `conjunto_potencia()` para elegir dos subconjuntos de $\{a,b,c\}$. Después, compruebe su unión, intersección y diferencia en el [laboratorio de operaciones con conjuntos](https://gilbertorodriguez59.github.io/libro-algebra-superior-r-geogebra/interactivos/operaciones-conjuntos.html). Así se coordinan la enumeración en R y la representación mediante regiones de Venn.
:::
...
[Abrir el laboratorio de tablas de verdad](https://gilbertorodriguez59.github.io/libro-algebra-superior-r-geogebra/interactivos/tablas-verdad.html){.btn .btn-primary target="_blank"}
...
![Cuatro operaciones representadas mediante regiones de Venn: unión, intersección, complemento y diferencia simétrica.](figures/venn-operaciones.png){#fig-venn-aplicado width=96% fig-alt="Cuatro diagramas de Venn muestran unión, intersección, complemento y diferencia simétrica."}
...
[Abrir el laboratorio de conjuntos](https://gilbertorodriguez59.github.io/libro-algebra-superior-r-geogebra/interactivos/operaciones-conjuntos.html){.btn .btn-primary target="_blank"}
...
![Una relación general, una función válida y una correspondencia que no cumple la definición de función.](figures/relacion-funcion.png){#fig-relacion-funcion-aplicado width=98% fig-alt="Tres diagramas sagitales comparan una relación general, una función y una correspondencia que no es función."}
...
![Recorrido de un elemento mediante $f$, después mediante $g$ y directamente mediante la composición $g\circ f$.](figures/composicion-funciones.png){#fig-composicion-aplicada width=90% fig-alt="Diagrama sagital que sigue un elemento mediante f y después mediante g para formar la composición."}
...
![La inyectividad evita imágenes repetidas; la suprayectividad exige cubrir todo el codominio; la biyección cumple ambas condiciones.](figures/tipos-funciones.png){#fig-tipos-funciones-aplicado width=98% fig-alt="Tres diagramas sagitales comparan funciones inyectiva, suprayectiva y biyectiva."}
...
[Abrir el clasificador de funciones](https://gilbertorodriguez59.github.io/libro-algebra-superior-r-geogebra/interactivos/clasificador-funciones.html){.btn .btn-primary target="_blank"}
...
![Implementación de $X=(A+\overline B)C$ con inversor, compuerta OR y compuerta AND.](figures/circuito-logico-booleano.png){#fig-circuito-booleano width=96% fig-alt="Circuito lógico: A y la negación de B entran a una compuerta OR; su salida y C entran a una compuerta AND que produce X."}
...
![Las señales se dividen en intervalos constantes; en cada uno se evalúa $X=(A+\overline B)C$.](figures/temporizacion-circuito.png){#fig-temporizacion-circuito width=96% fig-alt="Diagrama de temporización de las entradas A, B y C y la salida X durante seis intervalos."}

::: {.callout-note title="Lectura coordinada del circuito"}
Compare cada intervalo del diagrama de temporización con la fila correspondiente de la tabla de verdad y con el circuito de la @fig-circuito-booleano. Las compuertas y la burbuja del inversor siguen una convención gráfica uniforme basada en los símbolos lógicos estudiados por @tocci2003.
:::
