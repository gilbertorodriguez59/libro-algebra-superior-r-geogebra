...
![Del par cartesiano $(3,4)$ a radio $5$ y argumento $\theta$.](figures/plano-complejo.png){#fig-plano-complejo width=78% fig-alt="Punto en el plano complejo con sus coordenadas cartesianas, módulo y argumento."}
...
### Laboratorio web: coordenadas y argumento {.unnumbered .unlisted}

<iframe class="interactive-frame complex-plane" src="interactivos/plano-complejo.html" title="Laboratorio web de representación cartesiana y polar"></iframe>

[Abrir el laboratorio web en una pestaña nueva](https://gilbertorodriguez59.github.io/libro-algebra-superior-r-geogebra/interactivos/plano-complejo.html){.btn .btn-primary}
:::
...
![La diagonal representa $\mathbf u+\mathbf v$.](figures/suma-vectores.png){#fig-suma-vectores width=78% fig-alt="Regla del paralelogramo para la suma de dos vectores en el plano."}
...
[Abrir el laboratorio web en una pestaña nueva](https://gilbertorodriguez59.github.io/libro-algebra-superior-r-geogebra/interactivos/multiplicacion-compleja.html){.btn .btn-primary}
:::
...
![Conjugar refleja un punto respecto del eje real.](figures/conjugado-complejo.png){#fig-conjugado-complejo width=72% fig-alt="Un número complejo y su conjugado aparecen reflejados respecto del eje real."}
...
![Las raíces sextas de la unidad son los vértices de un hexágono regular.](figures/raices-unidad.png){#fig-raices-unidad width=72% fig-alt="Seis raíces de la unidad distribuidas uniformemente sobre la circunferencia unitaria."}
...
[Abrir el laboratorio web en una pestaña nueva](https://gilbertorodriguez59.github.io/libro-algebra-superior-r-geogebra/interactivos/raices-unidad.html){.btn .btn-primary}
:::
...
[Descargar el cuaderno](https://gilbertorodriguez59.github.io/libro-algebra-superior-r-geogebra/notebooks/capitulo-03-numeros-complejos-R.ipynb){.btn}
:::
...
| Cuaderno de Google Colab | Cuaderno completo del capítulo con código y ejercicios en R. | [Abrir en Google Colab](https://colab.research.google.com/github/gilbertorodriguez59/libro-algebra-superior-r-geogebra/blob/main/notebooks/capitulo-03-numeros-complejos-R.ipynb){target="_blank"} |
